$(document).ready(function () {
  ...
  function successInc() {
    $(".bl-success").append(
      '<div class="successInc">Utilisateur enregistré avec succès :)</div>'
    );
  }
  function messageInc() {
    $(".bl-messageInc").append(
      '<div class="messageInc">Confirmation mot de passe incorrect, veuillez réessayer svp!</div>'
    );
  }
  function messageTel() {
    $(".bl-messageTel").append(
      '<div class="messageInc">Ce champ ne doit pas être vide</div>'
    );
  }
  function messageEmail() {
    $(".bl-messageEmail").append(
      '<div class="messageInc">Ce champ ne doit pas être vide</div>'
    );
  }
  function messageMDP() {
    $(".bl-messageMDP").append(
      '<div class="messageInc">Ce champ ne doit pas être vide</div>'
    );
  }
